...
lusifar.addCommand({ pattern: 'twt ?(.*)', fromMe: td, desc: Lang.TWT}, async (message, match) => {
...
lusifar.addCommand({ pattern: 'show ?(.*)', fromMe: td , desc: Lang.SHOW}, async (message, match) => {
...
lusifar.addCommand({ pattern: 'twt ?(.*)', fromMe: true, dontAdCommandList: true}, async (message, match) => {
...
lusifar.addCommand({ pattern: 'show ?(.*)', fromMe: true , dontAdCommandList: true}, async (message, match) => {
