...
let td = Config.WORKTYPE == 'public' ? false : true
   ...
   lusifar.addCommand({pattern: 'spdf ?(.*)', fromMe: td, desc: Lang.SPDF }, (async (message, match) => {
...
lusifar.addCommand({pattern: 'spdf ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
