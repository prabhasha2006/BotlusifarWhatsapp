...
const lusifarv = fs.readFileSync('./uploads/voicenew/vvoice.mp3') 

let WORKN = Config.WORKTYPE == 'public' ? false : true
let WORKM = Config.WORKTYPE == 'public' ? true : true

    lusifar.addCommand({pattern: 'amo amo (.*)', fromMe: WORKN, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(message.jid, vvoice, MessageType.audio, {mimetype: 'audio/mp4', ptt:true}, {quoted: message.data})
