...
lusifar.addCommand({pattern: 'mediafire', fromMe: tn, desc: MMM}, (async (message, match) => {
  await message.sendMessage('• afire <your mediafire APK Link >\n • pfire <your mediafire PDF link>\n');
  
}));

 lusifar.addCommand({ pattern: 'pfire ?(.*)', fromMe: tn, dontAddCommandList:true,  deleteCommand: false}, async (message, match) => {
...
lusifar.addCommand({ pattern: 'afire ?(.*)', fromMe: tn, dontAddCommandList:true,  deleteCommand: false}, async (message, match) => {
