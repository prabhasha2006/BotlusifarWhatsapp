...
if (Config.WORKTYPE == 'private') {
    ...
    lusifar.addCommand({pattern: 'lusifar ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
     ...
     lusifar.addCommand({pattern: 'lusifar ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
